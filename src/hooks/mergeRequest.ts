...
const MR_STATUSES = [
    "open_waitnig_reviewer", // мр создан, поставлен ревьюер (поставил ревьюера)
    "wainting_owner", // ревьюер сделал ревью и оставил дискусы, поставил тэг дискус (поставил тег дискус)
